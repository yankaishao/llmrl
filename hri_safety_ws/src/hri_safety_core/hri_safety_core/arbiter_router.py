...
class ArbiterRouter(Node):
    def __init__(self) -> None:
        super().__init__("arbiter_router")
        self.declare_parameter("arbiter_mode", "rule")
        ...
        self.mode = str(self.get_parameter("arbiter_mode").value).lower()
        ...
        self.get_logger().info(f"arbiter_router started mode={self.mode}.")
    ...
    def on_features(self, msg: String) -> None:
        ...
        action = None
        if self.mode == "rl" and self.policy is not None:
